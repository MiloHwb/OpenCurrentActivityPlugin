...
/**
 * Guild: https://zhuanlan.zhihu.com/p/422548055
 */
class OpenCurrentActivityAction : AnAction() {
    override fun actionPerformed(event: AnActionEvent) {
        ...
        try {
            ...
            try {
                ...
                for (deviceId in deviceIdList) {
                    try {
                        ...
                        statusBar.info = "Could not parse adb output 1"
                    } catch (e: MultipleDevicesAdbException) {
                ...
                statusBar.info = "Could not parse adb output 2"
            ...
            showNotification(event, e.message!!)
            statusBar.info = "Could not parse adb output 3"
        } catch (e: NoDevicesAdbException) {
     ...
     */
    @Throws(
        ExecutionAdbException::class,
        MultipleDevicesAdbException::class,
        ParseAdbException::class,
        NoDevicesAdbException::class
    )
